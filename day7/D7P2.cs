...
{
    public static long GetFreeDiskSpace(this IEnumerable<(DirThing Dir, long TotalSize)> dirs)
    {
    ...
    public static long GetSizeOfSmallestDirNeededToGetEnoughSpace(this IEnumerable<(DirThing Dir, long TotalSize)> dirs)
    {
    ...
    public static long GetSizeOfSmallestDirWithAtLeastThisSize(this IEnumerable<(DirThing Dir, long TotalSize)> dirs, long minSize)
    {
